...
public class TestPensjonsprosentBehaviour extends ScenarioSupport<TestPensjonsprosentBehaviour>{
	...
	public void hovedregelVedPensjonsprosentberegningEr$spec$() {
		...
		eksempel.beregningAvPensjonsprosent("Kun 20 år opptjening før 1992", 20, 0, 22.5d);
	...
	public void maksimaltAntallOpptjeningsaarSomMedregnesEr40() {
		eksempel.beregningAvPensjonsprosent("Ekstra opptjening (ut over 40 år) fram til 1991 vil ikke medregnes", 41, 0, 45d);
		eksempel.beregningAvPensjonsprosent("Ekstra opptjening (ut over 40 år) fra og med 1992 vil ikke medregnes", 0, 41, 42d);
	}

	@Test
	public void opptjeningsaarFoer1992TellesFoerstNaarSummenAvOpptjeningsaarFoerOgEtter1992Overstiger40() {
		eksempel.beregningAvPensjonsprosent("Maksimal pensjonsprosent, 1 år etter 1991 tas ikke med", 40, 1, 45d);
		eksempel.beregningAvPensjonsprosent("Full opptjening, 2 opptjeningsår etter 1991 tas ikke med", 20, 22, 43.5d);
	}
